...
The plant cell wall determines cell shape, rigidity, and architecture ultimately affecting the mechanical strength of the plant tissues. There are two general types of cell walls, primary cell walls that are formed and modified while the cell is still growing and secondary cell walls that are laid down after the cell has stopped growing in the process of cell differentiation, for example into water conducting cells called xylem. <insert differences between the various cells with secondary cell walls> The production of these cell wall types requires the co-ordinated production, modification, and secretion of different polysaccharides such as cellulose, hemi-cellulose, and pectin into the extracellular matrix as well as programmed cell death.
